...
public class PCM03_Ram extends javax.swing.JFrame {
    Conectar conetc = new Conectar();  //Conexion 
    Connection con = conetc.conexion();//Conexion
    String idEmpd,idUser,Mmemoria,Mfrecuencia;
    double Mcuenta;
    String mother,ram;
    String [] ensamble = new String[11];
    double [] precios = new double[11];
    
    public PCM03_Ram(String empd,String user,double prec[],String ensa[]) {
    ...
    public void definirDatos(){
        ...
        try {
            ...
            ResultSet resultado = estado.executeQuery("select * from mother");
            while(resultado.next()){
                temp = resultado.getString("id_mother");
                if (temp.equals(mother)){
                    Mmemoria = resultado.getString("memoria");
                    Mfrecuencia = resultado.getString("frecuencia"); 
                }
            } 
    ...
    private void initComponents() {
        ...
        jlbImgRam = new javax.swing.JLabel();
        ...
        btnRam.setBackground(new java.awt.Color(255, 255, 153));
        btnRam.setFont(new java.awt.Font("Calibri", 1, 12)); // NOI18N
        btnRam.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PCMAKER/ButtonsImprove/ram2.png"))); // NOI18N
        ...
        jlbImgRam.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlbImgRam.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jlbImgRam.setPreferredSize(new java.awt.Dimension(300, 300));

        cmbRam.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        cmbRam.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecciona tu Memoria RAM" }));
        cmbRam.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                cmbRamPopupMenuWillBecomeInvisible(evt);
            }
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGap(38, 38, 38)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbRam, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 37, Short.MAX_VALUE)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(jlbImgRam, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
    ...
    private void cmbRamPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cmbRamPopupMenuWillBecomeInvisible
        ram = "" + cmbRam.getSelectedItem();
        mostrarDatos();
        mostrarImagen();
    }//GEN-LAST:event_cmbRamPopupMenuWillBecomeInvisible
    ...
    public void cargarDatos(){
        ...
        try{
            ...
            while(resultado.next()){
                temp = resultado.getString("id_mother");
                if (ensamble[1].equals(temp)) {
                    frec1= resultado.getInt("frecuencia");
                }
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null,"Se ha encontrado el siguiente error \n" + e,"Error detectado! ! !",JOptionPane.ERROR_MESSAGE);
        ...
        try{
            Statement estado = con.createStatement();
            ResultSet resultado = estado.executeQuery("select * from ram where tipo='"+ Mmemoria +"'");
            cmbRam.removeAllItems();
            while(resultado.next()){
                frec2 = resultado.getInt("frecuencia");
                if(frec2<=frec1){
                    cmbRam.addItem(resultado.getString(1));
                }
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null,"Se ha encontrado el siguiente error \n" + e,"Error detectado! ! !",JOptionPane.ERROR_MESSAGE);
    ...
    public void mostrarImagen(){
        ImageIcon IMGram = new ImageIcon(getClass().getResource("Imgram/" + ram + ".jpg"));
        ImageIcon icono = new ImageIcon(IMGram.getImage().getScaledInstance(300, 300, Image.SCALE_DEFAULT));
        jlbImgRam.setIcon(icono);
    }
    ...
    private javax.swing.JLabel jlbImgRam;
