...
public class Adventas1 extends javax.swing.JFrame {
    DefaultTableModel modelo = new DefaultTableModel();
    String idEmpd;
    int option=0,sitio=0;
    
    public Adventas1(String empd) {
    ...
    private void initComponents() {
        ...
        jtbEmpVentas = new javax.swing.JTable();
        ...
        btnEmpleados.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PCMAKER/ButtonsImprove/EMPLOY2.png"))); // NOI18N
        ...
        jtbEmpVentas.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jtbEmpVentas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "ID_Empleado", "Sucursal", "Comision"
            }
        ));
        jtbEmpVentas.setRowHeight(28);
        jtbEmpVentas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtbEmpVentasMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtbEmpVentas);
        ...
        txtEmple.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(txtEmple, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void jtbEmpVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbEmpVentasMouseClicked
        //sitio = Integer.parseInt(jtbEmpleados.getValueAt(jtbEmpleados.getSelectedRow(), 4).toString());
    }//GEN-LAST:event_jtbEmpVentasMouseClicked
    ...
    public void Limpiar(){
        for (int i = 0; i < jtbEmpVentas.getRowCount(); i++) {
            modelo.removeRow(i);
            i-=1;
        }
    }
    ...
    public void cargar1(){
        ...
        try{
            ...
            ResultSet resul = consul.executeQuery("select id_empleado,sum(costo)as total from compras group by id_empleado");
            while(resul.next()){
                datos[0]= resul.getString("id_empleado");
                datos[1]= "1";
    ...
    public void cargar2(){
        ...
        try{
            ...
            ResultSet resul = consul.executeQuery("select id_empleado,sum(costo)as total from compras group by id_empleado");
            while(resul.next()){
                datos2[0]= resul.getString("id_empleado");
                datos2[1]= "2";
    ...
    public void buscar1(){
        ...
        try{
            Statement consul = con1.createStatement();
            ResultSet resul = consul.executeQuery("select id_empleado,sum(costo)as total from compras where id_empleado='" + txtEmple.getText() + "'");
            if(resul.next()){
                datos[0]= resul.getString("id_empleado");
                datos[1]= "1";
                datos[2]= resul.getString("total");
    ...
    public void buscarGlobal(){
        Limpiar();
        buscar1();
        if(jtbEmpVentas.getValueAt(0, 0)==null){
            buscar2();    
        }
        if(jtbEmpVentas.getValueAt(0, 0)==null){
            buscar3();
    ...
    private javax.swing.JTable jtbEmpVentas;
