...
public class Adventas3 extends javax.swing.JFrame {
    DefaultTableModel modelo = new DefaultTableModel();
    String idEmpd;
    int option=0,sitio=0,cont=0;
    
    public Adventas3(String empd) {
        ...
        jtbSitioVentas.setModel(modelo);
    }
    ...
    private void initComponents() {
        ...
        jtbSitioVentas = new javax.swing.JTable();
        ...
        jtbSitioVentas.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jtbSitioVentas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jtbSitioVentas.setRowHeight(28);
        jtbSitioVentas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jtbSitioVentasMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jtbSitioVentas);
    ...
    private void jtbSitioVentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbSitioVentasMouseClicked
        //sitio = Integer.parseInt(jtbEmpleados.getValueAt(jtbEmpleados.getSelectedRow(), 4).toString());
    }//GEN-LAST:event_jtbSitioVentasMouseClicked
    ...
    private void btnSalir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalir1ActionPerformed
     ...
     public void Limpiar(){
        for (int i = 0; i < jtbSitioVentas.getRowCount(); i++) {
            modelo.removeRow(i);
            i-=1;
        }
    }
    ...
    public void cargar1(){
        ...
        try{
            ...
            ResultSet resul = consul.executeQuery("select sum(costo)as total from compras");
            while(resul.next()){
                datos[0]= "1";
                datos[1]= resul.getString("total");
                modelo.addRow(datos);
            }
    ...
    public void cargar2(){
        ...
        try{
            ...
            while(resul.next()){
                datos2[0]= "2";
                datos2[1]= resul.getString("total");
    ...
    private javax.swing.JTable jtbSitioVentas;
