...
public class Administracion1 extends javax.swing.JFrame {    
    DefaultTableModel modelo = new DefaultTableModel();
    String idEmpd;
    int option=0,sitio=0,cont=0;
    
    public Administracion1(String empd) {
    ...
    private void initComponents() {
        ...
        btnOption = new javax.swing.ButtonGroup();
        ...
        jtbEmpleados.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        jtbEmpleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_Empleado", "Apellidos", "Nombre", "Sexo", "Sucursal"
            }
        ));
        jtbEmpleados.setRowHeight(28);
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addComponent(txtEmpleado, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(34, 34, 34)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Adventas1 adv = new Adventas1(idEmpd);
        setVisible(false);
    }//GEN-LAST:event_jButton1ActionPerformed

    public void Limpiar(){
        for (int i = 0; i < jtbEmpleados.getRowCount(); i++) {
            modelo.removeRow(i);
            i-=1;
        }
    }
    ...
    public void cargar1(){
        ...
        try{
            ...
            ResultSet resul = consul.executeQuery("select * from empleados");
            while(resul.next()){
                datos[0]= resul.getString("id_empleado");
                datos[1]= resul.getString("apellidos");
                datos[2]= resul.getString("nombre");
                datos[3]= resul.getString("sexo");
                datos[4]= resul.getString("sucursal");
                modelo.addRow(datos);
            }
    ...
    public void cargar2(){
        ...
        try{
            ...
            while(resul.next()){
                ...
                datos2[1]= resul.getString("apellidos");
                datos2[2]= resul.getString("nombre");
                datos2[3]= resul.getString("sexo");
                datos2[4]= resul.getString("sucursal");
    ...
    public void buscar1(){
        ...
        try{
            Statement consul = con1.createStatement();
            ResultSet resul = consul.executeQuery("select * from empleados where id_empleado='" + txtEmpleado.getText() + "'");
            if(resul.next()){
                datos[0]= resul.getString("id_empleado");
                datos[1]= resul.getString("apellidos");
                datos[2]= resul.getString("nombre");
    ...
    private javax.swing.ButtonGroup btnOption;
