...
public class PCM05_Hdd extends javax.swing.JFrame {
    Conectar conetc = new Conectar();  //Conexion 
    Connection con = conetc.conexion();//Conexion
    double Gcuenta,cuenta;
    String idEmpd,idUser,hdd;
    String [] ensamble = new String[11];
    double [] precios = new double[11];
    
    public PCM05_Hdd(String empd,String user,double prec[],String ensa[]) {
        ...
        Gcuenta = precios[0] + precios[1] + precios[2] + precios[3];
        txtSubTotal.setText(Gcuenta + "");
        cargarDatos();
    }
    ...
    private void initComponents() {
        ...
        jlbImgHdd = new javax.swing.JLabel();
        cmbHdd = new javax.swing.JComboBox<>();
        ...
        btnHdd.setBackground(new java.awt.Color(255, 255, 153));
        btnHdd.setFont(new java.awt.Font("Calibri", 1, 12)); // NOI18N
        btnHdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PCMAKER/ButtonsImprove/hdd2.png"))); // NOI18N
        ...
        jlbImgHdd.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jlbImgHdd.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jlbImgHdd.setPreferredSize(new java.awt.Dimension(300, 300));

        cmbHdd.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        cmbHdd.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecciona tu Almacenamiento" }));
        cmbHdd.addPopupMenuListener(new javax.swing.event.PopupMenuListener() {
            public void popupMenuCanceled(javax.swing.event.PopupMenuEvent evt) {
            }
            public void popupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {
                cmbHddPopupMenuWillBecomeInvisible(evt);
            }
            public void popupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {
            }
        });
        cmbHdd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbHddActionPerformed(evt);
            }
        });
        ...
        jLabel14.setText("Inteface");

        txtInterface.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtInterface, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(43, 43, 43)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGap(38, 38, 38)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cmbHdd, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 37, Short.MAX_VALUE)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(jlbImgHdd, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cmbHdd, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(34, 34, 34)
                        .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void cmbHddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbHddActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbHddActionPerformed

    private void btnAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnteriorActionPerformed
        ensamble[4]=null;
        precios[4]=0;
        PCM04_Gpu PC04 = new PCM04_Gpu(idEmpd,idUser,precios,ensamble);
        setVisible(false);
    }//GEN-LAST:event_btnAnteriorActionPerformed

    private void cmbHddPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_cmbHddPopupMenuWillBecomeInvisible
        hdd = "" + cmbHdd.getSelectedItem();
        mostrarDatos();
        mostrarImagen();
    }//GEN-LAST:event_cmbHddPopupMenuWillBecomeInvisible
    ...
    public void cargarDatos(){
        try{
            ...
            ResultSet resultado = estado.executeQuery("select * from storage");
            cmbHdd.removeAllItems();
            while(resultado.next()){
                    cmbHdd.addItem(resultado.getString(1));
            }
        }catch(Exception e){
    ...
    public void mostrarDatos(){
        ...
        try{
            ...
            while(resul.next()){
                temp = resul.getString("id_storage");
                if (temp.equals(hdd)) {
                    ...
                    txtInterface.setText(resul.getString("interface"));
                    txtCapacidad.setText(resul.getString("capacidad"));
    ...
    public void mostrarImagen(){
        ImageIcon IMGhdd = new ImageIcon(getClass().getResource("Imgstorage/" + hdd + ".jpg"));
        ImageIcon icono = new ImageIcon(IMGhdd.getImage().getScaledInstance(300, 300, Image.SCALE_DEFAULT));
        jlbImgHdd.setIcon(icono);
    }
    ...
    private javax.swing.JComboBox<String> cmbHdd;
    ...
    private javax.swing.JLabel jlbImgHdd;
